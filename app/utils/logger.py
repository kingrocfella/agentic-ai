...
def sanitize_log_text(value: str) -> str:
    ...
    return _TOKEN_PARAM_RE.sub(r"\1[REDACTED_TOKEN]", value)
...
full_log_format = SanitizingFormatter(
...
if LOG_DIR and LOG_FILE:
    try:
        ...
        file_handler.setFormatter(full_log_format)
...
if LOG_DIR and ERROR_LOG_FILE:
    try:
        ...
        error_file_handler.setFormatter(full_log_format)
